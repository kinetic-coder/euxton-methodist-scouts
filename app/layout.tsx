            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link href="/" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-green-600 transition-colors">
                    Home
                  </Link>
                  <Link href="/about" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-green-600 transition-colors">
                    About
                  </Link>
                  <div className="relative group">
                    <button className="px-3 py-2 rounded-md text-sm font-medium hover:bg-green-600 transition-colors">
                      Sections
                    </button>
                  ...
                  <Link href="/contact" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-green-600 transition-colors">
                    Contact
                  </Link>
                </div>
              </div>
              ...
              <div className="md:hidden">
                <button className="text-white hover:text-green-200 focus:outline-none focus:text-green-200">
